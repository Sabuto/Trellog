        ...
        public static string Style(object text, MdStyle style)
        {
            ...
            switch (style)
            {
                ...
                case MdStyle.BoldItalic:
                    wrap = ItalicWrap + BoldWrap;
                    break;
                case MdStyle.Code:
                    wrap = CodeWrap;
                    break;
                case MdStyle.StrikeThrough:
                    wrap = StrikeThroughWrap;
                    break;
        ...
        public static string Format(object text, MdFormat format)
        {
            ...
            switch (format)
            {
                case MdFormat.None:
                    prefix = string.Empty;
                    break;
                case MdFormat.Heading1:
                    prefix = Heading1Prefix;
                    break;
                case MdFormat.Heading2:
                    prefix = Heading2Prefix;
                    break;
                case MdFormat.Heading3:
                    prefix = Heading3Prefix;
                    break;
                case MdFormat.Heading4:
                    prefix = Heading4Prefix;
                    break;
                case MdFormat.Heading5:
                    prefix = Heading5Prefix;
                    break;
                case MdFormat.Heading6:
                    prefix = Heading6Prefix;
                    break;
                case MdFormat.Quote:
                    prefix = QuotePrefix;
                    break;
                case MdFormat.UnorderedListItem:
                    prefix = UnorderedListItemPrefix;
                    break;
                case MdFormat.OrderedListItem:
                    prefix = OrderedListItemPrefix;
                    break;
